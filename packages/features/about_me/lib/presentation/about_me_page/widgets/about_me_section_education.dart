    ...
    children: [
      ...
      Expanded(
        child: Column(
          ...
          children: [
            Label('$labelKey.degree', style: context.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold)),
            Label(
            ...
            Label('$labelKey.major', style: context.textTheme.bodySmall, color: context.colorTokens.textSecondary),
          ],
        ),
      ),
    ],
