  ...
  pw.Widget build(pw.Context context) {
    return PfColumn(
      children: [
        ...
        CvTitleContainer(
          icon: FluentIcons.person_accounts_24_regular,
          title: 'label.cv.section.soft_skill',
          child: PfRow(
            children: [
              pw.Expanded(child: _SkillWidget('label.cv.section.soft_skill_1')),
              pw.SizedBox(width: Dimens.dimen6),
              pw.Expanded(child: _SkillWidget('label.cv.section.soft_skill_2')),
              pw.SizedBox(width: Dimens.dimen6),
              pw.Expanded(child: _SkillWidget('label.cv.section.soft_skill_3')),
            ],
          ),
        ),
      ],
...
class _SkillWidget extends pw.StatelessWidget {
  ...
  pw.Widget build(pw.Context context) => PfContainer(
    ...
    height: Dimens.dimen51,
    child: PfLabel(labelKey, style: const pw.TextStyle(fontSize: Dimens.dimen9)),
  );
}
