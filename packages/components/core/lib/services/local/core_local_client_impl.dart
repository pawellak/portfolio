...
class CoreLocalClientImpl extends CoreLocalClient {
  @override
  Future<Map<String, dynamic>> localFileByPath({required String feature, required String locale}) async {
    final file = await rootBundle.loadString('assets/features/$feature/data/$locale.json');
